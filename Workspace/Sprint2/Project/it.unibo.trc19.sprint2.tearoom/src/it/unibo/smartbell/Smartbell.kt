		...
		return { //this:ActionBasciFsm
				...
				state("waitingForClient") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t023",targetState="checkTemp",cond=whenRequest("notify"))
				}	 
				...
				state("waiterInfo") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t124",targetState="informClient",cond=whenEvent("waitingTimeEvent"))
				}	 
