		...
		return { //this:ActionBasciFsm
				...
				state("waitingForClient") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t029",targetState="checkTemp",cond=whenRequest("notify"))
				}	 
				...
				state("waiterInfo") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t130",targetState="informClient",cond=whenEvent("waitingTimeEvent"))
				}	 
