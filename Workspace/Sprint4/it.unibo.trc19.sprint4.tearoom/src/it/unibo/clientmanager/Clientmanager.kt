...
package it.unibo.clientmanager
...
class Clientmanager ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("waitingMsg") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t032",targetState="newClientState",cond=whenEvent("newClient"))
					transition(edgeName="t033",targetState="retrieveClientState",cond=whenEvent("nextState"))
					transition(edgeName="t034",targetState="handleAlarm",cond=whenDispatch("alarm"))
				}	 
				state("handleAlarm") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t035",targetState="stayOrLeave",cond=whenReply("clientStateRep"))
				}	 
				...
				state("newClientState") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t036",targetState="handleReply",cond=whenReply("tempResult"))
				}	 
				...
				state("waitToEnter") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t137",targetState="wait",cond=whenDispatch("inform"))
					transition(edgeName="t138",targetState="enter",cond=whenDispatch("accept"))
				}	 
					...
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("inform(ID,X)"), Term.createTerm("inform(ID,TIME)"), 
								 ...
								 var Time = payloadArg(1).toLong() 
												ID = payloadArg(0)
								forward("startTimer", "startTimer(clientmanager,alarm,$ID,$Time)" ,"timer" ) 
						}
					}
					 transition( edgeName="goto",targetState="waitingMsg", cond=doswitch() )
				}	 
				...
				state("retrieveClientState") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t039",targetState="progressClientState",cond=whenReply("clientStateRep"))
				}	 
				...
				state("makeOrder") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t040",targetState="progressClientState",cond=whenEvent("nextState"))
				}	 
