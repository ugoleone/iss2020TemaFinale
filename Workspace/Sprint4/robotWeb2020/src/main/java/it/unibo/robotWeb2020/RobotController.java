...
//		return getWebPageRep();
	...
	@MessageMapping("/new")
 	@SendTo("/topic/display")
 	public void newClient(RequestMessageOnSock message) throws Exception {
		ApplMessage msg = MsgUtil.buildEvent("web", "newClient", "newClient("+message.getName()+")" );
...
//		//WAIT for command completion ...
	...
	@MessageMapping("/prepare")
 	@SendTo("/topic/display")
 	public void prepareOrder(RequestMessageOnSock message) throws Exception {
// 		ApplMessage msg = MsgUtil.buildDispatch("web", "cmd", "cmd("+message.getName()+")", "basicrobot" );
		
		ApplMessage msg = MsgUtil.buildEvent("web", "prepare", "prepare("+message.getName()+")" );
		connQakSupport.emit( msg );
		System.out.println("------------------- RobotController emit=" + msg  );
//		doBusinessJob(message.getName(), null);
//		//WAIT for command completion ...
...
// 		ApplMessage msg = MsgUtil.buildDispatch("web", "cmd", "cmd("+message.getName()+")", "basicrobot" );
		...
		ApplMessage msg = MsgUtil.buildEvent("web", "nextState", "nextState("+message.getName()+")" );
		connQakSupport.emit( msg );
		System.out.println("------------------- RobotController emit=" + msg  );
//		doBusinessJob(message.getName(), null);
//		//WAIT for command completion ...
